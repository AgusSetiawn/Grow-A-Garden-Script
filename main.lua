...
frame.Size, frame.Position, frame.BackgroundColor3, frame.BackgroundTransparency =
    UDim2.new(0,180,0,170), UDim2.new(0,20,0,20), Color3.fromRGB(40,40,40), 0.2
...
icon.Image = "rbxassetid://3926307971" -- contoh icon bintang

-- title
local title = Instance.new("TextLabel", header)
title.Size, title.Position, title.BackgroundTransparency, title.Text =
    UDim2.new(1,-60,1,0), UDim2.new(0,30,0,0), 1, "Fairy Net Hub"
...
local delayBox = Instance.new("SetDelay", content)
